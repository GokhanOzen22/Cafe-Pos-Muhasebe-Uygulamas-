...
// Temiz kurulum: Menü ürünleri sıfırlandı
export const initialMenuItems: MenuItem[] = [];

// Temiz kurulum: Hammadde ve stok kartları sıfırlandı
export const initialStockItems: StockItem[] = [];

// Temiz kurulum: Tüm adisyonlar sıfırlandı
export const initialOrders: Order[] = [];

// Temiz kurulum: Alım faturaları sıfırlandı
export const initialPurchaseInvoices: PurchaseInvoice[] = [];

// Temiz kurulum: Gider faturaları sıfırlandı
